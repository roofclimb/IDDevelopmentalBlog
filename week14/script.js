...
$(document).ready(function () {
    ...
    $("#contact-submit").on("click", function (e) {
      ...
      let settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://interactivedev-e51d.restdb.io/rest/contact-04",
      ...
      $.ajax(settings).done(function (response) {
        ...
        for (var i = 0; i < response.length && i < limit; i++) {
          ...
          */
          ...
          <a href='#update-contact-container' class='update' data-id='${response[i]._id}' data-msg='${response[i].message}' data-name='${response[i].name}' data-email='${response[i].email}'>Update</a></td></tr>`;
    ...
    function updateForm(id, contactName, contactEmail, contactMsg) {
      ...
      var settings = {
        "async": true,
        "crossDomain": true,
        "url": `https://interactivedev-e51d.restdb.io/rest/contact-04/${id}`,//update based on the ID
        "method": "PUT",
        "headers": {
          "content-type": "application/json",
          "x-apikey": APIKEY,
    ...
    function deleteRecord(id) {
      var settings = {
        async: true,
        crossDomain: true,
        url: `https://interactivedev-e51d.restdb.io/rest/contact-04/${id}`,
        method: "DELETE",
        headers: {
          "content-type": "application/json",
          "x-apikey": APIKEY,
